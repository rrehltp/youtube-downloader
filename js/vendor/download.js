                    ...
                    var t = function (t, r) {
                        ...
                        (f.addData = function (t, r) {
                            ...
                            (f.createSvgTag = function (t, r, e, n) {
                                var o = {};
                                "object" == typeof arguments[0] && ((t = (o = arguments[0]).cellSize), (r = o.margin), (e = o.alt), (n = o.title)),
                                    (t = t || 2),
                                    (r = void 0 === r ? 4 * t : r),
                                ...
                                for (
                                    ...
                                    for (u = a * t + r, i = 0; i < f.getModuleCount(); i += 1) f.isDark(a, i) && (l += "M" + (i * t + r) + "," + u + c);
                        ...
                        return (
                            (f.createASCII = function (t, r) {
                                ...
                                var e,
                                    ...
                                    s = "";
                                for (e = 0; e < a; e += 1) {
                                    for (o = Math.floor((e - u) / t), s = "", n = 0; n < a; n += 1) (i = 1), u <= n && n < c && u <= e && e < c && f.isDark(o, Math.floor((n - u) / t)) && (i = 0), (s += i ? g : l);
                                    for (o = 0; o < t; o += 1) h += s + "\n";
                                }
                            ...
                            (f.renderTo2dContext = function (t, r) {
                                r = r || 2;
                                for (var e = f.getModuleCount(), n = 0; n < e; n++) for (var o = 0; o < e; o++) (t.fillStyle = f.isDark(n, o) ? "black" : "white"), t.fillRect(n * r, o * r, r, r);
                            }),
                            f
                        );
                    };
                    ...
                    var r,
                        ...
                        B =
                            ...
                            (o.getErrorCorrectPolynomial = function (t) {
                                for (var r = C([1], 0), e = 0; e < t; e += 1) r = r.multiply(C([1, k.gexp(e)], 0));
                                return r;
                            }),
                                ...
                                for (var r = t.getModuleCount(), e = 0, n = 0; n < r; n += 1)
                                    for (var o = 0; o < r; o += 1) {
                                        for (var i = 0, a = t.isDark(n, o), u = -1; u <= 1; u += 1)
                                            if (!(n + u < 0 || r <= n + u)) for (var f = -1; f <= 1; f += 1) o + f < 0 || r <= o + f || (0 == u && 0 == f) || (a == t.isDark(n + u, o + f) && (i += 1));
                                        i > 5 && (e += 3 + i - 5);
                                    }
                                for (n = 0; n < r - 1; n += 1)
                                    for (o = 0; o < r - 1; o += 1) {
                    ...
                    function C(t, r) {
                        ...
                        var e = (function () {
                            ...
                            n = {
                                ...
                                multiply: function (t) {
                                    for (var r = new Array(n.getLength() + t.getLength() - 1), e = 0; e < n.getLength(); e += 1) for (var o = 0; o < t.getLength(); o += 1) r[e + o] ^= k.gexp(k.glog(n.getAt(e)) + k.glog(t.getAt(o)));
                                    return C(r, 0);
                                },
                                mod: function (t) {
                                    if (n.getLength() - t.getLength() < 0) return n;
                                    for (var r = k.glog(n.getAt(0)) - k.glog(t.getAt(0)), e = new Array(n.getLength()), o = 0; o < n.getLength(); o += 1) e[o] = n.getAt(o);
                                    for (o = 0; o < t.getLength(); o += 1) e[o] ^= k.gexp(k.glog(t.getAt(o)) + r);
                                    return C(e, 0).mod(t);
                                },
                            };
                        return n;
                ...
                return (function (t) {
                    for (var r = [], e = 0; e < t.length; e++) {
                        ...
                        n < 128
                            ...
                            : (e++, (n = 65536 + (((1023 & n) << 10) | (1023 & t.charCodeAt(e)))), r.push(240 | (n >> 18), 128 | ((n >> 12) & 63), 128 | ((n >> 6) & 63), 128 | (63 & n)));
                    }
                    return r;
                })(t);
            }),
